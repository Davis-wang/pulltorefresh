...
import com.pulltorefresh.ILoadingLayout.State;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    /**
     * 重写addView，解决.xml布局文件中ScrollView有子控件却不显示bug，
     * 将PullToRefreshBase.class类中其他有单独出现addView的地方修改成super.addView();
     */
    @Override
    ...
    public final boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            // 2，isPullRefreshing()，如果当 前正在下拉刷新的话，是允许向上滑动，并把刷新的HeaderView挤上去
    ...
    protected void addRefreshableView(Context context, T refreshableView) {
        ...
        height = 10;
        addViewInternal(mRefreshableViewWrapper, new LinearLayout.LayoutParams(width, height));
    }
    ...
    protected void addHeaderAndFooter(Context context) {
        ...
        if (null != headerLayout) {
            ...
            addViewInternal(headerLayout, 0, params);
        }
        ...
        if (null != footerLayout) {
            ...
            addViewInternal(footerLayout, -1, params);
        }
    }
