/**
 * 文  件  名：RotateLoadingLayout1.java
 * 包        名：com.lee.pullrefresh.ui
 * 创建日期：2015-8-16
 * 作        者：cloudwise
 */
 ...
 * 修改日期：
 */
public class RotateLoadingLayout1 extends LoadingLayout{
     ...
     */
    public RotateLoadingLayout1(Context context) {
        super(context);
        init(context);
    }
     ...
     * @param attrs attrs
     */
    public RotateLoadingLayout1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
