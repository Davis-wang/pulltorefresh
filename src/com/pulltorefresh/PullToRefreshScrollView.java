...
public class PullToRefreshScrollView extends PullToRefreshBase<ScrollView> {
    ...
    public PullToRefreshScrollView(Context context) {
        this(context, null);
        //Toast.makeText(context, "PullToRefreshScrollView---Context", Toast.LENGTH_LONG).show();
    }
    ...
    public PullToRefreshScrollView(Context context, AttributeSet attrs) {
        ...
        //Toast.makeText(context, "PullToRefreshScrollView---Context + AttributeSet", Toast.LENGTH_LONG).show();
    }
    ...
    public PullToRefreshScrollView(Context context, AttributeSet attrs, int defStyle) {
        ...
        //Toast.makeText(context, "PullToRefreshScrollView---Context + AttributeSet + int", Toast.LENGTH_LONG).show();
    }
